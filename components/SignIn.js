...
export default function SignIn({setShowSignIn}) {
  return (
    <form className={`${styles.signup} p-8 mb-0 mt-20 h-max`}>
        ...
        <Stack className='gap-3 justify-center'>
          ...
          <Button className='signup-btn' variant="contained" color='primary'>Sign In</Button>
        ...
        <p className='text-center'>Dont have an account?
          <Button size="small" color="secondary">
            <span onClick={()=>{setShowSignIn(false)}}>Sign Up</span> 
          </Button>
        </p>
        </Stack>
